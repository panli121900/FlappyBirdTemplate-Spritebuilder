...
- (void)didLoadFromCCB {
    ...
    //The bush ratio is larger than the cloud ratio
    _bushParallaxRatio = ccp(0.9, 1);
    _cloudParallaxRatio = ccp(0.5 , 1);
    
    //redraw bushes with parallax
...
- (void)update:(CCTime)delta
{
    ...
    for (CCNode *bush in _bushes){
        ...
        //move the bush to the right if the left corner is one width off the screen
